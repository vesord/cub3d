...
# define ERR_PARSE_NO "Error occur while parsing NOrth texture."
# define ERR_PARSE_SO "Error occur while parsing SOuth texture."
# define ERR_PARSE_WE "Error occur while parsing WEst texture."
# define ERR_PARSE_EA "Error occur while parsing EAst texture."
